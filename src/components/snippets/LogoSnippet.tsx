...
export default function LogoSnippet({className, styles, svgProperties}: Props): ReactElement {
  return (
    <svg id="logo" viewBox="0 0 87 76" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"  className={className} style={{...styles}} {...svgProperties}>
      ...
      <path d="M18.5556 19.7143L7 24.5L18.5556 29.2857L23 40L27.4444 29.2857L39 24.5L27.4444 19.7143L23 9L18.5556 19.7143Z" stroke="#ED1C24" stroke-width="5"/>
      <path d="M59.5556 19.7143L48 24.5L59.5556 29.2857L64 40L68.4444 29.2857L80 24.5L68.4444 19.7143L64 9L59.5556 19.7143Z" stroke="#ED1C24" stroke-width="5"/>
